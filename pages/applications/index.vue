    ...
    <main class="">
        <div class="flex items-center justify-between mb-20">
            ...
            <div class="flex space-x-2">
                <UButton icon="i-heroicons-arrow-path-solid" size="sm" color="sky" variant="solid" label="Restart"
                    :trailing=" false " />
                <UButton icon="i-heroicons-arrow-path-solid" size="sm" color="red" variant="solid" label="Force Redeploy"
                    :trailing=" false " />
                <UButton icon="i-heroicons-pause" size="sm" color="amber" variant="solid" label="Stop"
                    :trailing=" false " />
                <UButton icon="i-heroicons-arrow-up-right" size="sm" color="primary" variant="solid" label="Open"
                    :trailing=" false " />
            </div>
        ...
        <UTabs orientation="vertical" :items=" tabItems " v-model=" tabIndex " :ui=" {
